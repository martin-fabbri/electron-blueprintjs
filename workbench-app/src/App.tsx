...
import {THEMES} from './navbar-css-ver';
...
import {default as CSSNavbar} from './navbar-css-ver';
    ...
    public render() {
        ...
        return (
            <div className={`app-container ${this.state.currentTheme === 'Dark Theme' ? 'bp3-dark' : ''}`}>
                ...
                <CSSNavbar currentTheme={this.state.currentTheme} setThemeState={this.setCurrentTheme}/>
                <AppNavbar/>
                    ...
                    renderTile={(id, path) => (
                        ...
                        >
                            ...
                            <div className="grid-container max-w-l mx-auto p-8">
                                ...
                                <div
                                    className="grid-axes bg-white rounded h-full text-grey-darkest shadow-md main-plot">
                                    <div className='x'>
                                        <ParametersSelect
                                            items={lines}
                                            filterable={false}
